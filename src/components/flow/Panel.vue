<template>
  <div class="panel" v-if="easyFlowVisible">
    <el-row>
      <!--顶部工具菜单-->
      <el-col :span="24">
        <div class="flow-tooltar">
          <el-link type="primary">{{ data.name }}</el-link>
          <el-button icon="el-icon-document" @click="dataInfo" size="mini"
            >流程信息</el-button
          >
          <el-button @click="dataReloadA" icon="el-icon-refresh" size="mini"
            >切换流程A</el-button
          >
          <el-button @click="dataReloadB" icon="el-icon-refresh" size="mini"
            >切换流程B</el-button
          >
          <el-button @click="dataReloadC" icon="el-icon-refresh" size="mini"
            >切换流程C</el-button
          >
          <!-- <el-button
            @click="changeLabel"
...
export default {
  ...
  methods: {
    ...
    jsPlumbInit() {
      this.jsPlumb.ready(() => {
        ...
        this.jsPlumb.bind("click", conn => {
          this.$refs.nodeForm.isNode = false;
          this.$refs.nodeForm.line = {
    ...
    clickNode(nodeId) {
      this.$refs.nodeForm.isNode = true;
